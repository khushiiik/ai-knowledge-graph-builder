...
def test_valid_question_returns_streaming_response(
    mock_provider, mock_intent, client, auth_headers
):
    ...
    assert (
        b"hello" in body.lower()
        or b"welcome" in body.lower()
        or b"conversation" in body.lower()
    )
