...
def test_batch_upload_validation():
    ...
    f1 = UploadFile(filename="test1.txt", file=BytesIO(b"Hello world file 1"), headers={"content-type": "text/plain"})
    # Test valid json file
    f2 = UploadFile(filename="test2.json", file=BytesIO(b'{"key": "value"}'), headers={"content-type": "application/json"})
